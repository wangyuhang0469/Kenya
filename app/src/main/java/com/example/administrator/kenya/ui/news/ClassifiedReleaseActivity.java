...
import com.example.administrator.kenya.view.RectangleImageView;
...
public class ClassifiedReleaseActivity extends BaseActivity {

    @Bind(R.id.title)
    TextView title;
    @Bind(R.id.img)
    RectangleImageView img;
    ...
    @OnClick({R.id.back, R.id.img, R.id.release})
        ...
        switch (view.getId()) {
            ...
            case R.id.release:
                if (mResults == null || mResults.size() == 0) {
                    ...
                    final LoadingDialog loadingDialog = new LoadingDialog(ClassifiedReleaseActivity.this);
                    loadingDialog.show();
    ...
    private void startCamera() {
        Intent intent = new Intent(ClassifiedReleaseActivity.this, MultiImageSelectorActivity.class);
        // 是否显示拍摄图片
