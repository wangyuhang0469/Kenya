...
public class LifeDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(AppConstants.BASE_URL + lifeServices.getUser().getUserPortrait())
                .centerCrop()
    ...
    private void loadComments() {
        OkHttpUtils.post()
                ...
                .addParams("thingsId", lifeServices.getLiveid())
                .addParams("thingsType", "lifeServices")
    ...
    private void addItemView(final Comment comment, final int position , boolean top) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("id" ,  lifeServices.getLiveid());
                bundle.putString("thingsType" , "lifeServices");
